...
const Contact = () => {
    ...
    return (
        <div className='flex items-center'>
            <Head>
                <title>Contact | Phyo Min Khant</title>
                ...
                <div className='grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5'>
                    <div className='lg:col-span-2'>
                        ...
                        <p className='max-w-xl text-lg pt-4'>
                            Have any questions? Send me email here! <br />I respond
                            ...
                            <a
                                ...
                                href='https://www.linkedin.com/in/phyo-min-khant-268453240/'
                                target='_blank'
                                rel='noopener noreferrer'
                            >
                                /in/phyo-min-khant-268453240/
                            </a>{' '}
                            <br />
                            Email:{' '}
                            <a
                                className='text-blue-500 hover:underline'
                                href='mailto:phyominkhant.dev@gmail.com'
                            >
                                phyominkhant.dev@gmail.com
                            </a>
